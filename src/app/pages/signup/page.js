...
export default function Signup() {
    ...
    return (
        <div className='flex justify-center items-center min-h-screen px-4'>
            ...
            >
                {({ isSubmitting }) => (
                    <Form className='lg:w-1/3 md:w-1/2 shadow-lg w-full rounded-2xl justify-center items-start bg-white flex flex-col gap-[28px] border-2 border-primary-color py-10 px-10'>
